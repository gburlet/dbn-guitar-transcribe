mirverbose(0);
mirwaitbar(0);
%mirparallel(1); % do parallel processing
...
y = sparse(total_frames, 128);    % preallocate for speed
...
%save pretrain.mat Xtrainb ytrainb Xtestb ytestb vishid hidrecbiases hidpen penrecbiases hidpen2 penrecbiases2 
